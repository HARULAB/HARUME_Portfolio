        ...
        <AnimatePresence>
          {!isMenuOpen && !hidden && (
            <motion.div
              ...
              className="flex items-center rounded-full pointer-events-auto h-12 border-2 border-white/70 backdrop-blur-xl"
              style={{ backgroundColor: "color-mix(in srgb, white 72%, transparent)", borderWidth: "2px" }}
            >
              <motion.button
